...
const TAILWIND_PALETTE: Record<string, string> = {
	...
	"zinc-50": "#fafafa", "zinc-100": "#f4f4f5", "zinc-500": "#71717a", "zinc-900": "#18181b",
	"neutral-50": "#fafafa", "neutral-100": "#f5f5f5", "neutral-500": "#737373", "neutral-900": "#171717",
	"stone-50": "#fafaf9", "stone-100": "#f5f5f4", "stone-500": "#78716c", "stone-900": "#1c1917",
			...
			<div className="space-y-8 max-w-2xl">
				...
				{parsed && matches.length > 0 && (
					<div className="space-y-6">
						<h2 className="text-xl font-semibold tracking-tight">Closest Matches</h2>
							...
							{matches.map((match, idx) => (
								...
								>
									...
									<div className="flex-1 space-y-1">
										...
										<div className="font-mono text-sm text-muted-foreground">{match.hex}</div>
									</div>
									{idx === 0 && (
