			...
			<div className="grid lg:grid-cols-[350px_1fr] gap-8">
				<div className="space-y-8 bg-card p-6 border border-border rounded-xl h-fit">
					<div className="space-y-3">
						...
						<Slider min={12} max={48} step={1} value={[fontSize]} onValueChange={([v]) => setFontSize(v)} />
					</div>
					...
					<div className="space-y-3">
						...
						<Slider min={300} max={1200} step={10} value={[width]} onValueChange={([v]) => setWidth(v)} />
					</div>

					<div className="pt-6 border-t border-border">
						<div className="text-center space-y-2">
							<div className="text-sm font-medium text-muted-foreground">Optimal Line Height</div>
