			...
			<div className="grid lg:grid-cols-[400px_1fr] gap-8">
				<div className="space-y-8 bg-card p-6 border border-border rounded-xl">
					<div className="space-y-4">
						<h3 className="font-semibold border-b border-border pb-2">Text Shadow</h3>
						<div className="space-y-3">
							<div className="flex justify-between">
								<Label>Offset X</Label>
								<span className="text-sm text-muted-foreground">{offsetX}px</span>
							</div>
							<Slider min={-20} max={20} value={[offsetX]} onValueChange={([v]) => setOffsetX(v)} />
						</div>
						<div className="space-y-3">
							<div className="flex justify-between">
							...
							<Slider min={-20} max={20} value={[offsetY]} onValueChange={([v]) => setOffsetY(v)} />
						</div>
						<div className="space-y-3">
							<div className="flex justify-between">
								<Label>Blur</Label>
					...
					<div className="space-y-4">
						<h3 className="font-semibold border-b border-border pb-2">Text Stroke</h3>
						<div className="space-y-3">
							<div className="flex justify-between">
								<Label>Stroke Width</Label>
								<span className="text-sm text-muted-foreground">{strokeWidth}px</span>
							</div>
							<Slider min={0} max={10} step={0.5} value={[strokeWidth]} onValueChange={([v]) => setStrokeWidth(v)} />
						</div>
						<div className="space-y-3">
							<Label>Stroke Color</Label>
							<div className="flex gap-4">
								<Input type="color" value={strokeColor} onChange={(e) => setStrokeColor(e.target.value)} className="w-12 p-1 h-10" />
